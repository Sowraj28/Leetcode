<h2><a href="https://leetcode.com/problems/check-if-any-element-has-prime-frequency/?envType=problem-list-v2&envId=math">3591. Check if Any Element Has Prime Frequency</a></h2><h3>Easy</h3><hr><p>You are given an integer array <code>nums</code>.</p>
